...
namespace Example
{
    class Program
    {
        ...
        {
            AnyCaptcha anycaptcha = new AnyCaptcha();


            var getBalanceRequest = anycaptcha.GetBalance(clientkey);
            ...
            var imageToTextRequest = anycaptcha.ImageToText(clientkey, "captcha.jpg");
            ...
            var hCaptchaRequest = anycaptcha.HCaptchaProxyless(clientkey, "51829642-2cda-4b09-896c-594f89d700cc", "http://democaptcha.com/");
            ...
            var recaptchaV2ProxylessRequest = anycaptcha.RecaptchaV2Proxyless(clientkey, "6Lc_aCMTAAAAABx7u2W0WPXnVbI_v6ZdbM6rYf16", "http://http.myjino.ru/recaptcha/test-get.php");
            ...
            var recaptchaV3ProxylessRequest = anycaptcha.RecaptchaV3Proxyless(clientkey, "6Leva6oUAAAAAMFYqdLAI8kJ5tw7BtkHYpK10RcD", "http://www.supremenewyork.com", "testPageAction", false);
            ...
            var funCaptchaProxylessRequest = anycaptcha.FunCaptchaProxyless(clientkey, "B7D8911C-5CC8-A9A3-35B0-554ACEE604DA", "https://outlook.live.com");
